...
import { ArrowRight, MapPin, Leaf, Users, ChevronLeft, ChevronRight, Accessibility, Search, Filter, Navigation as LucideNavigation, Loader2, Trees } from 'lucide-react';
...
const HERO_IMAGES = [
  {
    url: "https://images.unsplash.com/photo-1585938389612-a552a28d6914?auto=format&fit=crop&q=80&w=1920",
    title: "Şehrin Nefes Alanı",
    subtitle: "İstanbul'un saklı kalmış korularını keşfedin."
  },
  {
    url: "https://images.unsplash.com/photo-1441974231531-c6227db76b6e?auto=format&fit=crop&q=80&w=1920",
    title: "Doğa ile İç İçe",
    subtitle: "Hafta sonu kaçamakları için en iyi parklar."
  },
  {
    url: "https://images.unsplash.com/photo-1585320806297-9794b3e4eeae?auto=format&fit=crop&q=80&w=1920",
    title: "Tarihi Bostanlar",
    subtitle: "Kentin kadim tarım kültürüne tanıklık edin."
  },
  {
    url: "https://images.unsplash.com/photo-1470770841072-f978cf4d019e?auto=format&fit=crop&q=80&w=1920",
    title: "Yeşil İstanbul",
    subtitle: "Gelecek nesillere daha yeşil bir şehir."
  }
];
...
export default function LandingPage({ onStart, allSpaces, onSelectSpace, loading }: LandingPageProps) {
  ...
  const stats = useMemo(() => {
    return {
      ...
      accessible: allSpaces.filter(s => s["TEKERLEKLİ SANDALYE UYGUNLUK DURUMU"] === 'UYGUN').length,
      notAccessible: allSpaces.filter(s => s["TEKERLEKLİ SANDALYE UYGUNLUK DURUMU"] === 'DEĞİL').length
    };
  }, [allSpaces]);
    ...
    <div className="pt-16 min-h-screen bg-white dark:bg-dark-green-950 transition-all duration-300">
          ...
          <div className="relative">
            <div className="flex bg-white dark:bg-dark-green-900 rounded-3xl shadow-2xl border border-gray-100 dark:border-dark-green-800 p-2 overflow-hidden">
              <div className="flex-1 flex items-center px-4 gap-3">
                ...
                <input
                  type="text"
                  placeholder="Park adı veya adres ile hızlıca bul..."
                  value={searchTerm}
                ...
                >
                  {searchResults.length > 0 ? (
                    searchResults.map((space, idx) => (
                      ...
                      >
                        <div className="p-2 bg-green-100 dark:bg-dark-green-700 rounded-lg shrink-0">
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
              <div className="w-14 h-14 bg-green-100 dark:bg-dark-green-800 rounded-2xl flex items-center justify-center mx-auto mb-4">
                <Trees className="w-7 h-7 text-green-700 dark:text-primary" />
              </div>
              <p className="text-sm font-bold text-gray-500 dark:text-gray-400 uppercase tracking-widest mb-1">Toplam Yeşil Alan</p>
              <h3 className="text-4xl font-bold text-gray-900 dark:text-white">{loading ? <Loader2 className="w-8 h-8 animate-spin mx-auto" /> : stats.total}</h3>
            </motion.div>
            ...
            >
              <div className="w-14 h-14 bg-green-100 dark:bg-dark-green-800 rounded-2xl flex items-center justify-center mx-auto mb-4">
                <Accessibility className="w-7 h-7 text-green-700 dark:text-primary" />
              </div>
              <p className="text-sm font-bold text-gray-500 dark:text-gray-400 uppercase tracking-widest mb-1">Engelsiz Erişim</p>
              <h3 className="text-4xl font-bold text-gray-900 dark:text-white">{loading ? <Loader2 className="w-8 h-8 animate-spin mx-auto" /> : stats.accessible}</h3>
            </motion.div>
            ...
            >
              ...
              <p className="text-sm font-bold text-gray-500 dark:text-gray-400 uppercase tracking-widest mb-1">Kısıtlı Alan</p>
              <h3 className="text-4xl font-bold text-gray-900 dark:text-white">{loading ? <Loader2 className="w-8 h-8 animate-spin mx-auto" /> : stats.notAccessible}</h3>
            </motion.div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-primary/5 dark:bg-dark-green-900/30">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="font-display text-4xl font-bold text-gray-900 dark:text-white mb-4">Nasıl Kullanılır?</h2>
          ...
          <div className="grid md:grid-cols-3 gap-12 relative">
            ...
            <div className="relative z-10 flex flex-col items-center text-center">
              ...
              <p className="text-gray-600 dark:text-gray-400">Yakınındaki yeşil alanları görmek için konumunu etkinleştir.</p>
            </div>
            ...
            <div className="relative z-10 flex flex-col items-center text-center">
              ...
              <p className="text-gray-600 dark:text-gray-400">Park, bostan veya diğer yeşil alan türlerine göre sonuçları daralt.</p>
            </div>
            ...
            <div className="relative z-10 flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-bold mb-3 dark:text-white">3. Uygun Parkı Bul</h3>
              <p className="text-gray-600 dark:text-gray-400">Tekerlekli sandalye uygunluk bilgisine göre sana en uygun alanı seç.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-white dark:bg-dark-green-950 transition-all duration-300">
        <div className="max-w-7xl mx-auto px-4 text-center mb-16">
          <h2 className="font-display text-4xl font-bold text-gray-900 dark:text-white mb-4 transition-colors">Şehir İçin Yeşil Bir Rehber</h2>
          <div className="w-20 h-1 bg-primary mx-auto" />
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-12">
            ...
            >
              ...
              <h3 className="font-display text-2xl font-bold mb-4 dark:text-white transition-colors">Kolay Erişim</h3>
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed transition-colors">
                İstanbul genelindeki yeşil alanları tek bir harita üzerinde görün. İlçeye göre filtreleyin ve en yakın parkı bulun.
              </p>
            </motion.div>
            ...
            >
              ...
              <h3 className="font-display text-2xl font-bold mb-4 dark:text-white transition-colors">Detaylı Bilgi</h3>
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed transition-colors">
                Her bir yeşil alanın tam adresi ve engelli erişimine uygunluğu gibi kritik detaylara anında ulaşın.
              </p>
            </motion.div>
            ...
            >
              ...
              <h3 className="font-display text-2xl font-bold mb-4 dark:text-white transition-colors">Herkes İçin</h3>
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed transition-colors">
                Şehir hayatının stresiyle başa çıkmak isteyen her yaştan İstanbullu için tasarlanmış bir rehber.
              </p>
            </motion.div>
          </div>
        </div>
      ...
      <footer className="py-12 border-t border-gray-100 dark:border-dark-green-800 bg-white dark:bg-dark-green-950 transition-colors">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <p className="text-gray-400 dark:text-gray-500 text-sm">
            © 2026 İstanbul Yeşil Alan Rehberi. Veriler kamuya açık kaynaklardan sağlanmaktadır.
          </p>
        </div>
      </footer>
    </div>
